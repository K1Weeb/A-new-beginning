...
class Start:
    def __init__(self, parent):
        ...
        self.help_button = Button(self.hq_frame, text="HELP", font="arial 10 bold", bg="#DED221", command=lambda: self.help())
...
class Help:
    def __init__(self, partner):
        ...
        # create help frame with instructions to play quiz
        self.help_frame = Toplevel()
        self.help_thing = Frame(self.help_frame, padx=10, pady=10, bg="#111111")
        self.help_thing.grid(padx=10, pady=10)

        self.instructions_label = Label(self.help_thing, text="Test", bg="#111111")
        self.instructions_label.grid(padx=10, pady=10)
